...
export type TradeStateView = "reserved" | "sent" | "confirmed" | "expired" | "errored" | "rejected";
/**
 ...
 */
export type GuardCodeView = "EXECUTION_DISABLED" | "KILL_SWITCH" | "INVALID_INTENT" | "MINT_NOT_PINNED" | "MINT_DENIED" | "TOKEN2022_UNSUPPORTED" | "CAP_EXCEEDED" | "INSUFFICIENT_BALANCE" | "SLIPPAGE_EXCEEDED" | "PRIORITY_FEE_EXCEEDED" | "PRIORITY_FEE_INVALID" | "SIMULATION_FAILED" | "MIN_OUT_MISMATCH" | "DUPLICATE_INTENT" | "BROADCAST_FAILED" | "CONFIRM_TIMEOUT" | "SETTLE_SHORTFALL";
export type AgentPhase = "idle" | "observing" | "proposing" | "awaiting_approval" | "executing" | "settling" | "halted";
...
export type IntentKindView = "swap" | "perp_open" | "perp_increase" | "perp_reduce" | "perp_close" | "lp_add" | "lp_remove";
...
export type ActivityKind = "intent.received" | "guard.rejected" | "trade.reserved" | "trade.simulated" | "trade.signed" | "trade.sent" | "trade.confirmed" | "trade.failed" | "trade.dryrun" | "reconciler.sweep";
...
export declare const STRATEGY_STATUSES: readonly StrategyStatus[];
