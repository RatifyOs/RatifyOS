...
export declare function capsFor(policy: PerpsPolicy, bucket: QuoteBucket): PerpsCaps;
/**
 * Conservative defaults: perps disarmed, 3× leverage, 20% minimum liquidation
 * distance, 1 SOL / 200 USDC of collateral per position.
 */
export declare function defaultPerpsPolicy(): PerpsPolicy;
...
export declare function applyPerpsPolicyOverrides(base: PerpsPolicy, o: PerpsPolicyOverrides): PerpsPolicy;
/**
 ...
 */
export declare function leverageToBps(leverage: number): number | undefined;
/**
 ...
 */
export declare function notionalFromCollateral(collateralBaseUnits: bigint, leverage: number): bigint | undefined;
