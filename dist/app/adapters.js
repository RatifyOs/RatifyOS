import { ModelRouter, OpenAICompatibleTransport, } from "../agent/models/index.js";
export class RegistryDispatcher {
    registry;
    capabilities;
...
export class ModelRouterProvider {
    router;
    registry;
    options;
    id;
    constructor(router, registry, options) {
        this.router = router;
        this.registry = registry;
...
export function llmProviderId(llm) {
 ...
 */
export function createModelProvider(llm, registry, options) {
    ...
    return new ModelRouterProvider(new ModelRouter([candidate], { [LLM_TRANSPORT]: transport }), registry, {
        id: llmProviderId(llm),
